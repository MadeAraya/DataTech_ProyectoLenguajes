...
-- Sucursal
INSERT INTO tab_sucursal VALUES (1, 'DataTech San Pedro', 'San Jos�', 'Montes de Oca', 'Av52 Calle4', '22025633', 'datatechsanpedro.com');
INSERT INTO tab_sucursal VALUES (2, 'DataTech Alajuela', 'Alajuela', 'Alajuela', 'Av23 Calle1', '22789900', 'datatechalajuela.com');
INSERT INTO tab_sucursal VALUES (3, 'DataTech Heredia', 'Heredia', 'Bel�n', 'Av47A Calle13', '22771100', 'datatechheredia.com');
INSERT INTO tab_sucursal VALUES (4, 'DataTech Cartago', 'Cartago', 'Para�so', 'Av78 Calle23', '22001033', 'datatechcartago.com');
INSERT INTO tab_sucursal VALUES (5, 'DataTech Curridabat', 'San Jos�', 'Central', 'Av14 Calle3', '22471039', 'datatechcurridabat.com');
...
INSERT INTO tab_cliente VALUES (2, 'Ana', 'Garc�a', 'L�pez', 'anagarcia@gmail.com', '82345678', SYSDATE);
INSERT INTO tab_cliente VALUES (3, 'Juan', 'Mart�nez', 'S�nchez', 'juanmartinez@gmail.com', '87654321', SYSDATE);
INSERT INTO tab_cliente VALUES (4, 'Mar�a', 'Hern�ndez', 'Fern�ndez', 'mariahernandez@gmail.com', '73579246', SYSDATE);
INSERT INTO tab_cliente VALUES (5, 'Pedro', 'L�pez', 'G�mez', 'pedrolopez@gmail.com', '88765432', SYSDATE);
INSERT INTO tab_cliente VALUES (6, 'Laura', 'D�az', 'P�rez', 'lauradiaz@gmail.com', '84681357', SYSDATE);
INSERT INTO tab_cliente VALUES (7, 'Luis', 'Gonz�lez', 'Mart�nez', 'luisgonzalez@gmail.com', '66925814', SYSDATE);
INSERT INTO tab_cliente VALUES (8, 'Sof�a', 'Rodr�guez', 'Garc�a', 'sofiarodriguez@gmail.com', '88246137', SYSDATE);
INSERT INTO tab_cliente VALUES (9, 'Diego', 'S�nchez', 'Jim�nez', 'diegosanchez@gmail.com', '74185296', SYSDATE);
INSERT INTO tab_cliente VALUES (10, 'Carmen', 'P�rez', 'Ruiz', 'carmenperez@gmail.com', '85935746', SYSDATE);
INSERT INTO tab_cliente VALUES (11, 'Pablo', 'Mu�oz', 'Alvarez', 'pablomunoz@gmail.com', '82348765', SYSDATE);
INSERT INTO tab_cliente VALUES (12, 'Elena', 'Fern�ndez', 'L�pez', 'elenafdez@gmail.com', '88765431', SYSDATE);
INSERT INTO tab_cliente VALUES (13, 'Javier', 'Mart�nez', 'Gonz�lez', 'javiermartinez@gmail.com', '74185296', SYSDATE);
INSERT INTO tab_cliente VALUES (14, 'Marina', 'S�nchez', 'D�az', 'marinasanchez@gmail.com', '62345678', SYSDATE);
INSERT INTO tab_cliente VALUES (15, 'Roberto', 'Garc�a', 'Hern�ndez', 'robertogarcia@gmail.com', '86925814', SYSDATE);
INSERT INTO tab_cliente VALUES (16, 'Sara', 'P�rez', 'Mu�oz', 'saraperez@gmail.com', '88246137', SYSDATE);
INSERT INTO tab_cliente VALUES (17, 'Alejandro', 'L�pez', 'Rodr�guez', 'alejandrolpz@gmail.com', '74681357', SYSDATE);
INSERT INTO tab_cliente VALUES (18, 'Luc�a', 'Ruiz', 'S�nchez', 'luciaruiz@gmail.com', '83579246', SYSDATE);
INSERT INTO tab_cliente VALUES (19, 'Miguel', 'Jim�nez', 'G�mez', 'migueljimenez@gmail.com', '75935746', SYSDATE);
INSERT INTO tab_cliente VALUES (20, 'Paula', 'G�mez', 'P�rez', 'paulagomez@gmail.com', '82348765', SYSDATE);
...
INSERT INTO tab_producto VALUES (3, 1, 'Laptop Lenovo ThinkPad', 'Port�til resistente y seguro', 650000);
INSERT INTO tab_producto VALUES (4, 1, 'Laptop ASUS VivoBook', 'Laptop delgada y ligera con pantalla Full HD', 407000);
INSERT INTO tab_producto VALUES (5, 1, 'Laptop Apple MacBook Air', 'La potencia de Apple en un dise�o ultraport�til', 719000);
INSERT INTO tab_producto VALUES (6, 2, 'Monitor LG UltraWide', 'Pantalla panor�mica para una experiencia inmersiva', 239000);
INSERT INTO tab_producto VALUES (7, 2, 'Monitor Samsung 4K', 'Calidad de imagen excepcional con resoluci�n 4K UHD', 359900);
INSERT INTO tab_producto VALUES (8, 2, 'Monitor ASUS Gaming', 'Monitor dise�ado para la experiencia de juego', 290000);
INSERT INTO tab_producto VALUES (9, 2, 'Monitor HP LED', 'Monitor LED de alta definici�n para tareas diarias', 119000);
INSERT INTO tab_producto VALUES (10, 2, 'Monitor Dell UltraSharp', 'Precisi�n de color profesional para trabajos creativos', 477000);
INSERT INTO tab_producto VALUES (11, 3, 'Tablet Samsung Galaxy Tab', 'Tablet Android con pantalla brillante y delgada', 170500);
INSERT INTO tab_producto VALUES (12, 3, 'Tablet Apple iPad', 'La tableta iOS m�s popular con potencia y versatilidad', 200000);
INSERT INTO tab_producto VALUES (13, 3, 'Tablet Amazon Fire', 'Tablet asequible con acceso a contenido de Amazon', 59000);
INSERT INTO tab_producto VALUES (14, 3, 'Tablet Lenovo Tab', 'Tablet Android dise�ada para entretenimiento m�vil', 120000);
INSERT INTO tab_producto VALUES (15, 3, 'Tablet Huawei MediaPad', 'Tablet con pantalla Full HD y sonido envolvente', 209000);
INSERT INTO tab_producto VALUES (16, 4, 'Tarjeta gr�fica NVIDIA GeForce', 'Gr�ficos potentes para juegos y aplicaciones profesionales', 140600);
INSERT INTO tab_producto VALUES (17, 4, 'Procesador AMD Ryzen', 'Rendimiento de vanguardia para PC de escritorio', 230000);
INSERT INTO tab_producto VALUES (18, 4, 'Memoria RAM Corsair', 'M�dulos de memoria confiables para mejorar el rendimiento del sistema', 40000);
INSERT INTO tab_producto VALUES (19, 4, 'Disco duro SSD Samsung', 'Almacenamiento r�pido y confiable para tu PC', 77000);
INSERT INTO tab_producto VALUES (20, 4, 'Placa base ASUS ROG', 'Placa base dise�ada para entusiastas de los juegos', 100000);
INSERT INTO tab_producto VALUES (21, 5, 'Teclado mec�nico Razer', 'Teclado para juegos con interruptores mec�nicos', 25000);
INSERT INTO tab_producto VALUES (22, 5, 'Rat�n inal�mbrico Logitech', 'Rat�n ergon�mico para uso diario', 15000);
INSERT INTO tab_producto VALUES (23, 5, 'Auriculares Sony Noise Cancelling', 'Auriculares inal�mbricos con cancelaci�n de ruido', 17500);
INSERT INTO tab_producto VALUES (24, 5, 'Cargador inal�mbrico Anker', 'Cargador r�pido compatible con tel�fonos inteligentes', 11000);
INSERT INTO tab_producto VALUES (25, 5, 'Funda para port�til Case Logic', 'Funda acolchada para proteger tu port�til', 13900);

-- Proveedor
INSERT INTO tab_proveedor VALUES (1, 'Juan', 'Gonz�lez', '22364455', 'juangonzalez@gmail.com');
INSERT INTO tab_proveedor VALUES (2, 'Mar�a', 'Mart�nez', '88330211', 'mariamartinez@example.com');
INSERT INTO tab_proveedor VALUES (3, 'Carlos', 'Hern�ndez', '66773899', 'carlosperez@example.com');
INSERT INTO tab_proveedor VALUES (4, 'Laura', 'D�az', '77885766', 'lauragomez@example.com');
INSERT INTO tab_proveedor VALUES (5, 'Alejandro', 'Ruiz', '88223344', 'alejandromartinez@example.com');
INSERT INTO tab_proveedor VALUES (6, 'Ana', 'S�nchez', '66445066', 'anajimenez@example.com');
INSERT INTO tab_proveedor VALUES (7, 'Sof�a', 'Fern�ndez', '87637788', 'sofiagarcia@example.com');
INSERT INTO tab_proveedor VALUES (8, 'Pedro', 'G�mez', '71881900', 'pedroruiz@example.com');
INSERT INTO tab_proveedor VALUES (9, 'Luc�a', 'Guti�rrez', '64113293', 'luciatorres@example.com');
INSERT INTO tab_proveedor VALUES (10, 'Daniel', 'Mart�n', '89001122', 'danielsanchez@example.com');
...
-- Comentario
INSERT INTO tab_comentario VALUES (1, 1, 1, 4, 'Excelente laptop HP Pavilion, muy r�pido y confiable.', '10-05-2023');
...
INSERT INTO tab_comentario VALUES (3, 3, 6, 3, 'El monitor LG UltraWide es bueno, pero la calidad de imagen podr�a ser mejor.', '20-07-2023');
INSERT INTO tab_comentario VALUES (4, 4, 11, 5, 'La tablet Samsung Galaxy Tab es incre�ble, la mejor que he tenido.', '25-09-2023');
INSERT INTO tab_comentario VALUES (5, 5, 4, 2, 'No estoy satisfecho con la laptop ASUS VivoBook, esperaba m�s calidad.', '30-06-2023');
...
INSERT INTO tab_comentario VALUES (10, 10, 9, 3, 'El monitor HP LED es bueno para el precio, pero esperaba m�s resoluci�n.', '10-11-2023');
INSERT INTO tab_comentario VALUES (11, 11, 10, 5, 'El Dell UltraSharp tiene una precisi�n de color impresionante.', '20-09-2023');
...
INSERT INTO tab_comentario VALUES (14, 14, 13, 3, 'Buen tablet, pero la duraci�n de la bater�a podr�a ser mejor.', '30-10-2023');
INSERT INTO tab_comentario VALUES (15, 15, 25, 5, 'La funda para port�til Case Logic es excelente para proteger mi port�til.', '08-09-2023');
...
BEGIN
    ...
    CASE v_tabla
        ...
        ELSE
            DBMS_OUTPUT.PUT_LINE('Tabla no v�lida');
            RETURN;
    END CASE;
